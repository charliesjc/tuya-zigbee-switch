...
#define ZCL_CLUSTER_DIMMER_CONFIG 0xFC10
...
// Dimmer config cluster (manufacturer specific, 0xFC10)
#define ZCL_ATTR_DIMMER_CONFIG_SWITCH_TYPE 0x0000
#define ZCL_ATTR_DIMMER_CONFIG_MIN_LEVEL 0x0001
#define ZCL_ATTR_DIMMER_CONFIG_MAX_LEVEL 0x0002
